...
<%
	...
	String rIdx = request.getParameter("idx");
	...
	try {
	    ...
	    String sql = "DELETE FROM car WHERE carnum=? AND useridx=?;";
...
<div id="confirmCard">
<h2>취소가 완료되었습니다.</h2>
<a href="./userCar.jsp"><div id="button">확인</div></a>
</div>
<%
	 } catch (Exception e) {
	    e.printStackTrace();
...
<a href="./userCar.jsp"><div id="button">돌아가기</div></a>
</div>
<%
	 } finally {
